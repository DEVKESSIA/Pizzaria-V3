...
public class PizzasCad extends javax.swing.JFrame {
    private Pizzas janelaPizzas;
    private int ID;
    
    public PizzasCad(Pizzas janelaPizzas, int ID) {
        initComponents();
        ...
        if (ID != -1) {
            ...
            db.query("SELECT * FROM pizzas WHERE ID=" + ID);
            if (db.next()) {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String query = "";
        if (ID == -1) {
            query = "INSERT INTO pizzas (nome, ingredientes) ";
            query = query + "VALUES (";
            query = query + "'" + nome + "',";
